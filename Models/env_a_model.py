...
from Scores.env_a import ENV_A

INT_ENV_A = {}

for paragraph in ENV_A:
    ...
    INT_ENV_A[str(int_words)] = ENV_A[str(paragraph)]
    
for int_par in INT_ENV_A:
    print(int_par, INT_ENV_A[str(int_par)])
    print("\n\n\n")
...
- take each paragraph and convert into a list of words
- take each word in said paragraphs and get integer equivalent from word index
- add integer word into an array
- put that list of integers back into our dictionary that maps it to the score
